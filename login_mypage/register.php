                ...
                <div class="form_contents">
                    ...
                    <div class="password">
                        ...
                        <label>パスワード（半角英数字6文字以上）</label><br>
                            <input type="password" class="text" size="40" name="password" id="password" pattern="^[a-zA-Z0-9]{6,}$" required>
                    </div>
                    <div class="password">
                        <div class="hissu">必須</div>
                        <label>パスワード確認</label><br>
                            <input type="text" class="text" size="40" name="confirm_password" id="confirm" oninput="ConfirmPassword(this)" required>
                    </div>
                    <div class="picture">
